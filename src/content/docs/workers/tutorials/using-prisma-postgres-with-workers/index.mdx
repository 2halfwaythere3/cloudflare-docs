...
You can connect to Prisma Postgres using Prisma Accelerate or [Hyperdrive](/hyperdrive). Both approaches provide comparable performance with different tradeoffs.
