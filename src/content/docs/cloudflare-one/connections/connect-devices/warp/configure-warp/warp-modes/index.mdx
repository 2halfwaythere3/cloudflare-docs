...
| WARP Mode                                    | DNS Filtering | Network Filtering | HTTP Filtering | Service mode (displayed in `warp-cli settings`) | Description                                                                                                                                                                                                        |
| -------------------------------------------- | ------------- | ----------------- | -------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| **Device Information Only**                  | ❌            | ❌                | ❌             | `PostureOnly`                                   | <details><summary>View</summary>Allows enforcement of device posture rules for self-hosted Access applications using client certificates. No DNS, network, or HTTP traffic is sent through WARP tunnels.</details> |
